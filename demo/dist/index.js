...
/***/ function(module, exports, __webpack_require__) {
	...
	var _distStyleSheetJs = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../dist/StyleSheet.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _distStyleSheetJs2 = _interopRequireDefault(_distStyleSheetJs);

	window.sheetjs = { StyleSheet: _distStyleSheetJs2['default'] };
	var s = new _distStyleSheetJs2['default']().stylesForSelector;
	...
	function toggleElements() {
	  var $toggleStatus = (0, _jquery2['default'])('.toggle-status').empty();
	  var timestamp = Date.now();
	  var toggler = selectedLibrary === 'SheetJS' ? toggleWithSheetjs : toggleWithJquery;

	  (0, _lodash.times)(numberOfTimesToToggle, toggler);
	  $toggleStatus.html('<span>' + numberOfTimesToToggle + ' toggles with <em>' + selectedLibrary + '</em>: <strong>' + (Date.now() - timestamp) + 'ms</strong></span>');
	}
	...
	function toggleWithJquery() {
	  isToggled = !isToggled;
	  (0, _jquery2['default'])('.' + demoElClass).css('background-color', isToggled ? toggleColor2 : toggleColor1);
	}

	function inputChanged() {
	  (0, _jquery2['default'])('.update-settings').attr('disabled', false);
	  (0, _jquery2['default'])('.toggle-elements').attr('disabled', true);
	}

	function updateSettings() {
	  // isToggled = false;
	  numberOfEls = parseInt((0, _jquery2['default'])('.number-of-els').val());
	  demoElClass = (0, _jquery2['default'])('.demo-el-class').val();
	  toggleColor1 = (0, _jquery2['default'])('.color-1').val();
	  toggleColor2 = (0, _jquery2['default'])('.color-2').val();
	  numberOfTimesToToggle = parseInt((0, _jquery2['default'])('.toggle-count').val());
	  selectedLibrary = (0, _jquery2['default'])('.library-select').val();
	  s('.' + demoElClass).backgroundColor = toggleColor1;

	  (0, _jquery2['default'])('.update-settings').attr('disabled', true);
	  (0, _jquery2['default'])('.toggle-elements').attr('disabled', false);
	  (0, _jquery2['default'])('.toggle-status').html('');
	  updateDemoElStyles();
	  updateDemoEls();
	}
	...
	function updateDemoEls() {
	  (0, _jquery2['default'])('.demo-el-container').empty().html(renderDemoEls());
	}
	...
	function renderDemo() {
	  return [(0, _jquery2['default'])('<div/>', {
	    'class': 'button-bank',
	    html: [(0, _jquery2['default'])('<span/>', {
	      html: 'Number of elements:'
	    }), (0, _jquery2['default'])('<input/>', {
	      type: 'text',
	      'class': 'number-of-els',
	      value: numberOfEls
	    }), (0, _jquery2['default'])('<br/>'), (0, _jquery2['default'])('<span/>', {
	    ...
	    }), (0, _jquery2['default'])('<br/>'), (0, _jquery2['default'])('<select/>', {
	      'class': 'library-select',
	      value: selectedLibrary,
	      html: [(0, _jquery2['default'])('<option/>', {
	        value: 'SheetJS',
	    ...
	    }), (0, _jquery2['default'])('<br/>'), (0, _jquery2['default'])('<button/>', {
	  ...
	  }), (0, _jquery2['default'])('<hr/>'), (0, _jquery2['default'])('<div/>', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"/Users/Jeff/developer/sheetjs/node_modules/webpack/buildin/module.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))(module), (function() { return this; }())))
